...
class CCADP
{
    public:
        ...
        int broadcastCancelFlagForCCADP = 8;
        ...
        vector<int> RunCCADPForSourceNode(int sourceNodeID, Network network);
        vector<int> RunCCADP(int sourceNodeID, Network network);
        ...
        vector<int> RunCCADPForSourceDestinationNode(int sourceNodeID, int destinationNodeID, Network network);
        ...
        void UpdateReceiverStatus(int sourceNodeID, vector<int> forwardListOfCCADP, Network network);
