...
class OTDP
{
    public:
        ...
        int broadcastCancelFlagForOTDP = 8;
        ...
        vector<int> RunOTDPForSourceNode(int sourceNodeID, Network network);
        vector<int> RunOTDP(int sourceNodeID, Network network);
        ...
        vector<int> RunOTDPForSourceDestinationNode(int sourceNodeID, int destinationNodeID, Network network);
        ...
        void UpdateReceiverStatus(int sourceNodeID, vector<int> forwardListOfOTDP, Network network);
